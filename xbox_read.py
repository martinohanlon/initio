#Class to read xbox controller events from xboxdrv stdout
#Original code from https://github.com/zephod/lego-pi
#Used in project http://blog.zephod.com/post/37120089376/lego-xbox-raspberry-pi

#Minor mods by Martin O'Hanlon
...
def event_stream(deadzone=0,scale=32768):
    ...
    #subprocess = popen('nohup xboxdrv')
    while (True):
...
if __name__ == '__main__':
    for event in event_stream(deadzone=7000):
        if event.key=='X1':
